...
namespace WebService.Request
{
    ...
    public class Sospecha
    {
        ...
        /// <summary>
        /// Indica que el resultado informado se obtuvo por medio de pool testing
        /// </summary>
        /// <remarks>
        /// true -> Pool testing realizado
        /// false -> Pool testinf no realizado
        /// ausente -> Pool testing no realizado
        /// </remarks>
